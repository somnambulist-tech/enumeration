...
use Somnambulist\Components\Enumeration\Tests\Fixtures\InvalidEnumeration;
use Somnambulist\Components\Enumeration\Tests\Fixtures\ValidEnumeration;
...
class AbstractEnumerationTest extends TestCase
{
    ...
    public function testMemberByKey()
    {
        ...
        $this->assertInstanceOf('Somnambulist\Components\Enumeration\Tests\Fixtures\ValidEnumeration', $foo);
        $this->assertInstanceOf('Somnambulist\Components\Enumeration\Tests\Fixtures\ValidEnumeration', $bar);

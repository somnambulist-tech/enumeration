...
use Somnambulist\Components\Enumeration\Tests\Fixtures\InvalidValueMultiton;
use Somnambulist\Components\Enumeration\Tests\Fixtures\ValidValueMultiton;
...
class AbstractValueMultitonTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $reflector = new ReflectionClass(AbstractMultiton::class);
    ...
    public function testMemberByKey()
    {
        ...
        $this->assertInstanceOf('Somnambulist\Components\Enumeration\Tests\Fixtures\ValidValueMultiton', $foo);
        $this->assertInstanceOf('Somnambulist\Components\Enumeration\Tests\Fixtures\ValidValueMultiton', $bar);
        ...
        $this->assertSame(array(
            array(
                'Somnambulist\Components\Enumeration\Tests\Fixtures\ValidValueMultiton::initializeMembers',
                array(),
            ),
    ...
    {
        $this->expectException('Somnambulist\Components\Enumeration\Exception\UndefinedMemberException');
    ...
    {
        $this->expectException('Somnambulist\Components\Enumeration\Exception\ExtendsConcreteException');

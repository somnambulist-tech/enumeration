...
use Somnambulist\Components\Enumeration\Tests\Fixtures\InvalidMultiton;
use Somnambulist\Components\Enumeration\Tests\Fixtures\ValidMultiton;
...
class AbstractMultitonTest extends TestCase
{
    ...
    public function testMemberByKey()
    {
        ...
        $this->assertInstanceOf('Somnambulist\Components\Enumeration\Tests\Fixtures\ValidMultiton', $foo);
        $this->assertInstanceOf('Somnambulist\Components\Enumeration\Tests\Fixtures\ValidMultiton', $bar);
        ...
        $this->assertSame(array(
            array(
                'Somnambulist\Components\Enumeration\Tests\Fixtures\ValidMultiton::initializeMembers',
                array(),
            ),
        ), ValidMultiton::calls());
    }

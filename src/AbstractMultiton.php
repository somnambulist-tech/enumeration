...
use Somnambulist\Components\Enumeration\Exception\UndefinedMemberExceptionInterface;
...
abstract class AbstractMultiton implements MultitonInterface
{
     ...
     */
    final public function anyOf(MultitonInterface $a, MultitonInterface $b): bool
    {
    ...
    {
        throw new RuntimeException(sprintf('Cannot serialize instances of %s', self::class));
    }
    ...
    private static array $members = array();
    private string $key;
}
